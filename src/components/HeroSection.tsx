...
export const HeroSection = () => {
  ...
  return <section className="relative min-h-[80vh] flex items-center bg-gradient-to-br from-primary-light via-white to-white overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          ease: "easeOut"
            ...
            {/* Trust Badges */}
            <motion.div className="flex flex-wrap gap-3" initial={{
            opacity: 0
          }} animate={{
            opacity: 1
          }} transition={{
            ...
            duration: 0.5
              ...
              <Button size="lg" className="bg-gradient-primary text-white hover:shadow-xl transition-all duration-200 group" onClick={scrollToCars}>
                Browse Cars
          ...
          ease: "easeOut"
            ...
            <div className="relative">
              ...
              {/* Floating Stats */}
              <motion.div className="absolute -top-6 -right-6 bg-white rounded-xl shadow-hover p-4" initial={{
              opacity: 0,
              y: -20,
              scale: 0.9
            }} animate={{
