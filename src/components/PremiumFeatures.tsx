...
import { Shield, Clock, MapPin, Star, Smartphone, CreditCard, Car } from 'lucide-react';
...
export const PremiumFeatures = () => {
  return <section className="py-20 bg-gradient-to-br from-primary/5 via-accent-purple/5 to-primary/10 overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        duration: 0.6
          ...
          delay: index * 0.1
              ...
              <motion.div className="text-4xl lg:text-5xl font-bold text-gradient bg-gradient-to-r from-primary to-accent-purple bg-clip-text text-transparent mb-2" whileInView={{
        ...
        duration: 0.6
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button size="lg" variant="secondary" className="bg-white text-primary hover:bg-white/90 px-8 py-3 font-semibold">
                Start Your Journey
              </Button>
              <Button size="lg" variant="ghost" className="text-white border-white hover:bg-white/10 px-8 py-3">
                Learn More
              </Button>
            </div>
          </div>
