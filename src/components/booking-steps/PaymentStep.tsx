          ...
          <div className="space-y-3">
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <h3 id="full-payment-label" className="font-medium">
                    Pay Full Amount Now
                  </h3>
                ...
                <div className="text-right">
                  ...
                  {!advanceBooking && <Badge className="mt-1">Selected</Badge>}
                </div>
              </div>
            </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <h3 id="hold-payment-label" className="font-medium">
                    Pay 10% to Hold
                  </h3>
                  <p className="text-sm text-muted-foreground mt-1">
                  ...
                  <div className="mt-2 p-2 bg-blue-50 rounded text-xs text-blue-700">
                    Pay 10% now to reserve this car for 24 hours. If full
                    payment is not completed the hold will be released
                    automatically.
                  </div>
                </div>
                <div className="text-right">
